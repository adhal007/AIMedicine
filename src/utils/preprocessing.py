...
class MedicalImagePreprocessC1:
    def __init__(self,  
...
class MedicalImageEDA(MedicalImagePreprocess):
    def __init__(self, train_df: pd.DataFrame, valid_df: pd.DataFrame, test_df: pd.DataFrame, labels: list, img_dir: str, target_w: int = 320, target_h: int = 320) -> None:
        super().__init__(train_df, valid_df, test_df, labels, img_dir, target_w, target_h)
